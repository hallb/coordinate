...
| GLO-029 | Receipt | | Documentation of an Expense from the provider (dentist, pharmacist, therapist, etc.). Must include: patient name, provider name, service date, and itemized services and amounts. Required for claim submission. See NFR-006 for retention requirements. |
